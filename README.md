...
[![LICENSE](https://img.shields.io/github/license/yaoyao-liu/minimal-light?style=flat-square&logo=creative-commons&color=EF9421)](https://github.com/ebruevcen/minimal-light/blob/main/LICENSE)
...
The latest version of my homepage is available here: [[link](https://github.com/ebruevcen/ebruevcen.github.io)]
<br>
...
```bash
git clone https://github.com/ebruevcen/minimal-light.git
cd minimal-light
```
Install and run:
